namespace AJut.UnitTests.Core
{
    ...
    public class ListExtensionTests
    {
        ...
        [TestMethod]
        public void ListXT_BinarySearch_SearchForMissing_EvenNumberOfItems_Works ()
        {
            ...
            int actual = numbers.BinarySearch(6);
            int mine = numbers.BinarySearchXT(6);
            Assert.AreEqual(numbers.BinarySearch(6), numbers.BinarySearchXT(6));
        }
        [TestMethod]
        public void ListXT_BinarySearch_SearchForMissing_OddNumberOfItems_Works ()
        {
            List<int> numbers = new List<int>
            {
                1, 2, 4, 5, 7
        ...
        [TestMethod]
        public void ListXT_BinarySearch_SearchForMissing_StartOfSequence_Works ()
        {
            List<int> numbers = new List<int>
            {
                1, 2, 4, 5, 7
            ...
            Assert.AreEqual(numbers.BinarySearch(0), numbers.BinarySearchXT(0));
        }

        [TestMethod]
        public void ListXT_BinarySearch_SearchForMissing_EndOfSequence_Works ()
        {
            List<int> numbers = new List<int>
            {
                1, 2, 4, 5, 7
            ...
            Assert.AreEqual(numbers.BinarySearch(16), numbers.BinarySearchXT(16));
        }

        [TestMethod]
        public void ListXT_BinarySearch_SearchForContained_EvenNumberOfItems_Works ()
        {
            List<int> numbers = new List<int>
            {
                1, 2, 3, 4, 5, 7
            ...
            Assert.AreEqual(2, numbers.BinarySearchXT(3));
        }
        [TestMethod]
        public void ListXT_BinarySearch_SearchForContained_OddNumberOfItems_Works ()
        {
            List<int> numbers = new List<int>
            {
                1, 2, 4, 5, 7
        ...
        [TestMethod]
        public void ListXT_BinarySearch_SearchForContained_BeginningOfSequence_Works ()
        {
            List<int> numbers = new List<int>
            {
                1, 2, 4, 5, 7
        ...
        [TestMethod]
        public void ListXT_BinarySearch_SearchForContained_EndOfSequence_Works ()
        {
            List<int> numbers = new List<int>
            {
                1, 2, 4, 5, 7
