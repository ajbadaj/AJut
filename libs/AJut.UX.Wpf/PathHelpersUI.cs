namespace AJut.UX
{
    ...
    public static class PathHelpersUI
    {
        ...
        public static string PromptUserToPickADirectory (string prompt = "Select a folder", string currentPath = null)
        {
            var dlg = new FolderPicker();
            dlg.Title = prompt;
            dlg.InputPath = currentPath ?? Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
            if (dlg.ShowDialog() == true)
            {
