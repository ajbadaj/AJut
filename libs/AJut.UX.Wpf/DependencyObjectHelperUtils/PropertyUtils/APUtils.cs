namespace AJut.UX
{
    ...
    public static class APUtils<TOwner>
    {
        ...
        /// <returns>The <see cref="DependencyProperty" /> that was registered for this attached property.</returns>
        public static DependencyProperty Register<TProperty> (StaticAPUtils.GetterFunc<TProperty> getter, StaticAPUtils.SetterFunc<TProperty> setter, TProperty defaultValue, CastedPropertyChangedCallback<TProperty> propChanged, CoerceValueCallback coerceValue)
        {
        ...
        /// <param name="setter">The attached property's setter (verified for required verbiage and type).</param>
        /// <returns>The <see cref="DependencyProperty"/> that was registered for this attached property.</returns>
        public static DependencyPropertyKey RegisterReadOnly<TProperty> (StaticAPUtils.GetterFunc<TProperty> getter, StaticAPUtils.SetterFunc<TProperty> setter)
        {
        ...
        /// <param name="defaultValue">The default value for the attached property.</param>
        /// <returns>The <see cref="DependencyProperty"/> that was registered for this attached property.</returns>
        public static DependencyPropertyKey RegisterReadOnly<TProperty> (StaticAPUtils.GetterFunc<TProperty> getter, StaticAPUtils.SetterFunc<TProperty> setter, TProperty defaultValue)
        {
        ...
        /// <param name="propChanged">The property changed callback delegate.</param>
        /// <returns>The <see cref="DependencyProperty"/> that was registered for this attached property.</returns>
        public static DependencyPropertyKey RegisterReadOnly<TProperty> (StaticAPUtils.GetterFunc<TProperty> getter, StaticAPUtils.SetterFunc<TProperty> setter, CastedPropertyChangedCallback<TProperty> propChanged)
        {
        ...
        /// <param name="propChanged">The property changed callback delegate.</param>
        /// <returns>The <see cref="DependencyProperty"/> that was registered for this attached property.</returns>
        public static DependencyPropertyKey RegisterReadOnly<TProperty> (StaticAPUtils.GetterFunc<TProperty> getter, StaticAPUtils.SetterFunc<TProperty> setter, TProperty defaultValue, CastedPropertyChangedCallback<TProperty> propChanged)
        {
        ...
        /// <param name="metadata">The property metadata to register for this attached property with the dependency property system.</param>
        /// <returns>The <see cref="DependencyProperty"/> that was registered for this attached property.</returns>
        public static DependencyPropertyKey RegisterReadOnly<TProperty> (StaticAPUtils.GetterFunc<TProperty> getter, StaticAPUtils.SetterFunc<TProperty> setter, PropertyMetadata metadata)
        {
            StaticAPUtils.ValidateAccessors(getter, setter);
