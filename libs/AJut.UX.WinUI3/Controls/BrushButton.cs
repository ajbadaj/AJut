namespace AJut.UX.Controls
{
    ...
    public class BrushButton : _ManagedBrushButton
    {
        ...
        {
            get => (Brush)this.GetValue(NormalBackgroundProperty);
        ...
        {
            get => (Brush)this.GetValue(NormalForegroundProperty);
        ...
        {
            get => (Brush)this.GetValue(NormalBorderBrushProperty);
        ...
        {
            get => (Brush)this.GetValue(PointerOverBackgroundProperty);
        ...
        {
            get => (Brush)this.GetValue(PointerOverForegroundProperty);
        ...
        {
            get => (Brush)this.GetValue(PointerOverBorderBrushProperty);
        ...
        {
            get => (Brush)this.GetValue(PressedBackgroundProperty);
        ...
        {
            get => (Brush)this.GetValue(PressedForegroundProperty);
        ...
        {
            get => (Brush)this.GetValue(PressedBorderBrushProperty);
        ...
        {
            get => (Brush)this.GetValue(DisabledBorderBrushProperty);
