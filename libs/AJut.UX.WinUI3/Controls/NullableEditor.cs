namespace AJut.UX.Controls
{
    ...
    using DPUtils = AJut.UX.DPUtils<NullableEditor>;
    ...
    //
    // Template parts:
    //   PART_InnerContent  - ContentControl for the inner T editor
    ...
    //
    // VSM groups:
    //   NullableStates - IsNull / HasValue

    [TemplatePart(Name = nameof(PART_InnerContent), Type = typeof(ContentControl))]
    ...
    public class NullableEditor : Control
    {
        ...
        private ContentControl PART_InnerContent { get; set; }
        ...
        {
            this.DefaultStyleKey = typeof(NullableEditor);
        ...
        protected override void OnApplyTemplate ()
        {
            ...
            this.PART_InnerContent = this.GetTemplateChild(nameof(PART_InnerContent)) as ContentControl;
